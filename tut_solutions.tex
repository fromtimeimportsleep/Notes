...
% Showing the existence of such a function is a little more involved. We use the \textbf{Axiom of Choice}\footnote{If anyone is able to prove existence without the Axiom of Choice (or any variant), please contact the author.}.\\
