...
\begin{document}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \tikzset{edge/.style = {->,> = latex',midway}}            
            % Define nodes
            \node[vertex] (bottom1) at (0,0) {};
            \node[vertex] (bottom2) at (2,0) {};
            \node[vertex] (middle) at (1,1.5) {};
            \node[vertex] (left) at (-0.5,1.5) {};
            \node[vertex] (right) at (2.5,1.5) {};
            \node[vertex] (lol) at (-1,0) {};
            \node[vertex] (top1) at (0,3) {};
            \node[vertex] (top2) at (1,3) {};
            \node[vertex] (top3) at (2,3) {};
            
            % Draw edges
            \draw[edge] (bottom1) -- (middle);
            \draw[edge] (bottom2) -- (middle);
            \draw[edge] (middle) -- (top1);
            \draw[edge] (middle) -- (top2);
            \draw[edge] (middle) -- (top3);
            \draw[edge] (left) -- (top1);
            \draw[edge] (right) -- (top3);
            \draw[edge] (lol) -- (left);
        \end{tikzpicture}
