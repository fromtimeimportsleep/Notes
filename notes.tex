...
\begin{document}
    ...
    \begin{solution}
        ...
        How do we know these $k$ collections are distinct? Assume 2 of them are same, say the ones where
    ...
    \end{exercise}
    \begin{solution}
        Nope this is false. There are actually infinitely many counterexamples. Take numbers 
        of the form $\binom{24k+2}{4}$. This equals $\frac{(24k+2)(24k+1)(24k)(24k-1)}{(4)(3)(2)(1)} \\
    ...
    \end{exercise}
    \begin{solution}
        This is also false. Let's try to construct counterexamples of the form $\binom{6n}{6}$.
        ...
        that $15 \mid (2n-1)$ and $4 \mid (3n-1)$. For this we just to find inverses
